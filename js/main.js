...
for (info of data) {
  ...
  var elSpawnItem = document.createElement("span");
  var elMulti = document.createElement("span");
  ...
  elHeight.textContent = `${info.height}`;
  elWeight.textContent = `${info.weight}`;
  elCandy.textContent = `${info.candy}`;
  elEgg.textContent = `${info.egg}`;
  elSpawn.textContent = `${info.spawn_chance}`;
  elAvg.textContent = `${info.avg_spawns}`;
  elSpawnItem.textContent = `${info.spawn_time}`;
  elMulti.textContent = `${info.multipliers}`;
  ...
  elHeight.setAttribute("class", "texts");
  elWeight.setAttribute("class", "texts");
  elCandy.setAttribute("class", "texts");
  elEgg.setAttribute("class", "texts");
  elSpawn.setAttribute("class", "texts");
  elAvg.setAttribute("class", "texts");
  elSpawnItem.setAttribute("class", "texts");
  elMulti.setAttribute("class", "texts");
  ...
  newItem.appendChild(elSpawnItem);
  newItem.appendChild(elMulti);
